...
/**
 * Functional interface that given a TableColumn displaying instances of Image
 * creates instances of TableCell set to display said image using a ImageView.
 */
public class ImageCellFactory<T> implements Callback<
        TableColumn<T, Image>, TableCell<T, Image>> {
